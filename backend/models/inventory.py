...
#     payment_source = db.Column(db.String(20), nullable=True, default="OTHER")
...
VALID_CATEGORIES = ("Dry Staples", "Perishables", "Cold Storage")
...
class RawMaterial(db.Model):
    ...
    unit = db.Column(db.String(30), nullable=False)   # kg, litre, pcs
    cost_per_unit = db.Column(db.Numeric(10, 2), default=0)
    category = db.Column(db.String(50), nullable=False, default="Dry Staples")
    supplier_id = db.Column(db.Integer, db.ForeignKey("suppliers.id"), nullable=True)
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
