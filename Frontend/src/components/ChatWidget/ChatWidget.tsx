...
import BakerBot, { WhatsAppIcon } from "./Bakerbot";

import "./ChatWidget.css";

const HISTORY_KEY = "chatbot_history";

// WhatsApp number in international format (no +, no spaces). 965 = Kuwait country code.
const WHATSAPP_NUMBER = "96597526285";
const WHATSAPP_URL = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
  "Hello Cake N Take, I'd like to know more about your cakes."
)}`;
...
const ChatWidget: React.FC = () => {
  ...
  if (!isOpen) {
    return (
      <div className="baker-fab-group">
        <a
          className="baker-wa-fab"
          href={WHATSAPP_URL}
          target="_blank"
        ...
        >
          ...
          <span className="baker-fab-tip">WhatsApp us</span>
        </a>

        <button
          className="baker-fab baker-hover-target"
          onClick={() => setIsOpen(true)}
          aria-label="Open Baker chat assistant"
        >
          <span className="baker-fab-ring" aria-hidden="true" />
          <BakerBot size={44} />
          <span className="baker-fab-tip">Hi! Need help? 👋</span>
        </button>
      </div>
    );
  }
  ...
  return (
    ...
    >
      <div className="baker-chat-header">
        <div className="baker-chat-header-title">
          <span className="baker-chat-avatar">
            <BakerBot size={34} animate={false} />
            <span className="baker-online-dot" />
          </span>
        ...
        <div className="baker-chat-header-actions">
          <a
            className="baker-icon-btn baker-wa-link"
            href={WHATSAPP_URL}
            target="_blank"
            rel="noopener noreferrer"
      ...
      <div className="baker-chat-input-row">
        ...
        <button
          className={`baker-voice-btn ${isRecording ? "is-recording" : ""}`}
          onClick={
            isRecording
              ? stopRecording
              : () => {
      ...
      <div className="baker-chat-footer">
        Prefer a person?{" "}
