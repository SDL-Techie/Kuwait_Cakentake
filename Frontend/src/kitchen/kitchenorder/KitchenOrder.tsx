...
// //       {/* ─── Date / Month / Day Filter Bar ─── */}
// //       <div className="ko-date-filter-bar">
// //         <div className="ko-date-filter-group">
...
// //         {dateFilterMode !== 'all' && (
// //           <button className="ko-date-filter-clear" onClick={clearDateFilter}>
// //             Clear filter
// //           </button>
// //         )}
// //       </div>
...
// //                   {/* Pickup-only actions once the order is ready for pickup */}
...
// //                         <button
// //                           className={`ko-payment-badge-btn ${isPaid ? 'is-paid' : 'is-pending'}`}
// //                           disabled={isPaid || actionLoading === order.id}
// //                           onClick={(e) => togglePaymentMenu(order.id, e)}
// //                         >
// //                           <IconCash size={13} />
// //                           {isPaid ? `Paid · ${order.payment_method || ''}` : 'Payment'}
// //                         </button>

// //                         {isPaymentMenuOpen && !isPaid && (
...
// //                             <button
// //                               className="ko-payment-popover-option"
// //                               onClick={(e) => handleSelectPaymentMethod(order.id, 'UPI', e)}
// //                             >
// //                               Online (UPI)
// //                             </button>
// //                           </div>
...
// //                     {/* Pickup-only actions in the modal footer */}
...
// //                         <div className="ko-payment-menu-wrap">
// //                           <button
// //                             className={`ko-payment-badge-btn ${(selectedOrder.payment_status || '').toUpperCase() === 'PAID' ? 'is-paid' : 'is-pending'}`}
// //                             disabled={
...
// //                             <IconCash size={13} />
// //                             {(selectedOrder.payment_status || '').toUpperCase() === 'PAID'
// //                               ? `Paid · ${selectedOrder.payment_method || ''}`
// //                               : 'Payment'}
// //                           </button>
...
// //                               <button
// //                                 className="ko-payment-popover-option"
// //                                 onClick={(e) => handleSelectPaymentMethod(selectedOrder.id, 'UPI', e)}
// //                               >
// //                                 Online (UPI)
// //                               </button>
// //                             </div>
